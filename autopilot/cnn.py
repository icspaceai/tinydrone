...
img_width = 320
img_height = 240
crop_img_height, crop_img_width = 200, 200
...
train_generator = train_datagen.flow_from_directory("../collision_dataset/training", 
                                                                            shuffle = True, 
                                                                            color_mode=img_mode, 
...
val_generator = val_datagen.flow_from_directory("../collision_dataset/validation",
                                                                            shuffle = True, 
                                                                            color_mode=img_mode, 
                                                                            target_size=(img_width, img_height), 
                                                                            batch_size =32)
